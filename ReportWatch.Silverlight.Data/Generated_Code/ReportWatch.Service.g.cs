...
namespace ReportWatch.Database
{
        ...
        public Guid DayPriceId
        {
            ...
            set
            {
                if ((this._dayPriceId != value))
                {
                    ...
                    this.RaisePropertyChanged("DayPriceId");
    ...
    public sealed partial class Report : Entity
    {
        ...
        private decimal _reportPriceHigh;
        ...
        partial void OnReportPriceHighChanging(decimal value);
        ...
        /// <summary>
        /// Gets or sets the 'ReportPriceHigh' value.
        /// </summary>
        [DataMember()]
        public decimal ReportPriceHigh
        {
            get
            {
                return this._reportPriceHigh;
            }
            set
            {
                if ((this._reportPriceHigh != value))
                {
                    this.OnReportPriceHighChanging(value);
                    this.RaiseDataMemberChanging("ReportPriceHigh");
                    this.ValidateProperty("ReportPriceHigh", value);
                    this._reportPriceHigh = value;
                    this.RaiseDataMemberChanged("ReportPriceHigh");
                    this.OnReportPriceHighChanged();
                }
            }
        }
    ...
    public sealed partial class Symbol : Entity
    {
        ...
        private EntityCollection<DayPrice> _daySet;
        ...
        partial void OnDateReportChanging(Nullable<DateTime> value);
        ...
        /// <summary>
        /// Gets or sets the 'DateReport' value.
        /// </summary>
        [DataMember()]
        public Nullable<DateTime> DateReport
        {
            ...
            set
            {
                if ((this._dateReport != value))
                {
                    ...
                    this.RaiseDataMemberChanging("DateReport");
                    this.ValidateProperty("DateReport", value);
                    this._dateReport = value;
                    this.RaiseDataMemberChanged("DateReport");
        ...
        public EntityCollection<DayPrice> DaySet
        {
            get
            {
                ...
                {
                    this._daySet = new EntityCollection<DayPrice>(this, "DaySet", this.FilterDaySet, this.AttachDaySet, this.DetachDaySet);
                }
                return this._daySet;
            }
        }
        ...
        private void AttachDaySet(DayPrice entity)
        {
            entity.Symbol = this;
        }
        
        private void DetachDaySet(DayPrice entity)
        {
            entity.Symbol = null;
        }
        
        private bool FilterDaySet(DayPrice entity)
        {
            return (entity.SymbolName == this.SymbolName);
        }
